...
removal_process_errors = {
    1: ('Не удалось удалить, похоже, что приложение уже отсутствует на устройстве', 'not success'),
    2: ('Не удалось удалить, похоже, что устройство не подключено, или на нем не включена отладка по USB', 'fail'),
